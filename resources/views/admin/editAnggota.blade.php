...
@section('content')         
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="row">
                    <form method="post" enctype="multipart/form-data"  action="{{url('/editAnggotaPost')}}">
                    {{ csrf_field() }}
                        <div class="profile card" style="padding:50px">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4  img-profile text-center">
                                    <img src="/img/profile/{{$data->profile}}" style="width:100%;height:300px;" alt="">
                                ...
                                <div class="col-lg-8 col-md-8  info-profile">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="nama" id="nama" style="width:350px" type="text" value="{{$data->nama}}" required class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td style="padding-right:80px;">Bahasa</td>
                                        <td style="padding-right:20px;">:</td>
                                        <td><input name="bahasa" id="bahasa" type="text" required value="{{$data->bahasa}}" class="form-control"></td>
                                    </tr>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="pengalaman">
                                    ...
                                    <hr>
                                    <textarea name="pengalaman" id="pengalaman" class="form-control"  required id="exampleFormControlTextarea1" style="resize: none;" rows="8">{{$data->pengalaman}}</textarea>
