...
@section('content')
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <form method="post" enctype="multipart/form-data"  action="{{url('/addPaketPost')}}">
                    {{ csrf_field() }}
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="deskripsi">
                                    ...
                                    <input name="nama" id="nama"  type="text" value="" required placeholder="Nama Paket" class="form-control"> 
                                    <br>
                                    <h5>Gambar : <input type="file"  required name="gambar" id="gambar" ></h5>
                                    <br>
                                    <input  id="kategori" name="kategori" type="text" placeholder="Kategori Paket" value=""   required class="form-control">
                                    <br>
                                    <input type="text" name="lokasi" id="lokasi" placeholder="Lokasi" value=""   required class="form-control">
                                    <br> 
                                    <input type="text" name="harga" id="harga" placeholder="harga Paket" value=""   required class="form-control">
                                    <br>                                                                       
